...
```bash
git clone https://github.com/Albion14/java-project-61.git
cd java-project-61
```
...
![alt text](app/src/main/resources/1.png)![alt text](app/src/main/resources/2.png)![alt text](app/src/main/resources/3.png)![alt text](app/src/main/resources/4.png)![alt text](app/src/main/resources/5.png)